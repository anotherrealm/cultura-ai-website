        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 fade-in">
            ...
            <div className="space-y-4">
              ...
              <div className="w-24 h-1 bg-gradient-to-r from-[#d6b06f] to-[#73ffb4] mx-auto lg:mx-0"></div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative w-80 h-80 md:w-96 md:h-96">
                ...
                <div className="absolute inset-8 flex flex-col items-center justify-center text-center space-y-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#d6b06f] to-[#73ffb4] rounded-full flex items-center justify-center mb-4">
                    <Globe className="w-6 h-6 text-white" />
                  </div>
                  
                  <div className="space-y-2">
                    <h3 className="text-lg font-semibold text-[#d6b06f]">Cultural AI</h3>
                    <p className="text-sm text-[#342603]/80">Preserving Heritage</p>
                  </div>
